...
export default function IncomesNavigator(){
    return(
       <BottomTab.Navigator>
           <BottomTab.Screen name="Agregar Ingreso" component={IncomesForm} options={{headerShown: false}} />
           <BottomTab.Screen name="Ver Ingresos" component={IncomesListNavigator} options={{headerShown: false}}/>
       </BottomTab.Navigator> 
    )
}